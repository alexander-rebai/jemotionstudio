...
const Footer = () => {
  ...
  return (
    <footer className="bg-charcoal">
      <div className="px-6 md:px-16 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <p className="mt-4 text-cream/50 text-sm text-center md:text-left max-w-xs">
              Persoonlijke zorg voor jouw beweging. Kinesitherapie, osteopathie
              en sportrevalidatie in Gent.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="text-cream/50 text-sm text-center md:text-left space-y-2">
      ...
      {/* Bottom Bar */}
      <div className="px-6 md:px-16 py-6 border-t border-cream/10">
        <p className="text-cream/30 text-xs text-center">
          &copy; 2025 JE Motion Studio
        </p>
      </div>
    </footer>
  );

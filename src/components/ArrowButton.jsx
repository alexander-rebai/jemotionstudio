...
const ArrowButton = ({
  ...
  const isDark = background === "#2C2C2C" || background === "#7A3321";
  const fillColor = isDark ? "white" : "#2C2C2C";
  ...
  const buttonClasses = `group flex items-center justify-center gap-2 px-7 h-[52px] rounded-none text-xs md:text-sm cursor-pointer transition-all duration-300 uppercase tracking-[0.15em] font-medium hover:opacity-90 ${textClass}`;
